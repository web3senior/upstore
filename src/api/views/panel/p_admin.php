                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if ((empty($value['avatar']) || !file_exists('upload/images/' . $value['avatar']))) : ?>
                                                <span class="badge badge-light">بدون تصویر</span>
                                            <?php else : ?>
                                                <a target="_blank" href="<?= URL ?>upload/images/<?= $value['avatar'] ?>" class="btn-more">
                                                    <?= ICON_OPEN ?>
                                                </a>
                                            <?php endif; ?>
                                        </td>
                                        <td><?= $value['email'] ?></td>
                                        <td>***</td>
                                        <td className="text-center"><?= empty($value['purpose']) ? '-' : null ?></td>
                                        <td>
