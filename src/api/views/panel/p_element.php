                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= URL ?>panel/<?= $this->endpoint ?>/insert" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div>
                                <fluent-text-area appearance="filled" placeholder="" name="message">پیام</fluent-text-area>
                            </div>
    ...
    const editRow = async (id) => {
        ...
        return await fetch('<?= URL ?>panel/<?= $this->endpoint ?>/info/' + id, requestOptions)
            ...
            .then(result => {
                ...
                document.querySelector('fluent-text-area[name="message"]').value = result.message
