        ...
        <div class="ms-Grid-col ms-sm12 ms-md12 ms-lg6" style="position:sticky;top:0">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                                <fluent-text-field appearance="filled" name="name" value="<?= isset($_GET['name'])? $_GET['name']:''?>">نام</fluent-text-field>
                            </div>

                            <fluent-button appearance="accent" type="submit" id="btn-update">جستجو</fluent-button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <div>
                                <fluent-text-field appearance="filled" name="tel">لینک</fluent-text-field>
                            </div>
