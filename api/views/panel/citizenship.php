        ...
        <div class="ms-Grid-row">
                                  ...
                                  <tr>
                                      ...
                                      <td>
                                          <div class="d-flex justify-content-between">
                                              ...
                                              <a href="<?= URL ?>panel/citizenship/delete?id=<?= $id ?>"><?= ICON_DELETE ?></a>
                                      </td>
                                  </tr>
                                <?php
                              }
            ...
            <div class="ms-Grid-col ms-sm12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= URL ?>panel/citizenship/insert" method="post" autocomplete="off">
...
<script type="text/javascript">
    ...
    const editRow = async (id) => {
        ...
        return await fetch('<?= URL ?>panel/citizenship/info/' + id, requestOptions)
            .then(response => response.json())
            .then(result => {
                    console.log(result)
                    loading(false)
                    document.querySelector('input[name="name"]').value = result.name
                    document.querySelector('form').action = `<?= URL ?>panel/citizenship/update/${id}`
