                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= URL ?>panel/<?= $this->endpoint ?>/insert" method="post" enctype="multipart/form-data" autocomplete="off">
                            <div>
                                مشتری: <a href="<?= URL . "panel/education" ?>"><span class="badge badge-pill badge-primary">ویرایش</span></a>
                               
                                <input type="text" list="province" name="client_id" title="انتخاب کارمند" require />
...
<script type="text/javascript">
    ...
    const handleEdit = async (id) => {
        ...
        document.querySelector('fluent-text-field[name="dt"]').value = result.dt
        document.querySelector('[name="total"]').value = result.total
        document.querySelector('fluent-number-field[name="period"]').value = result.period
        document.querySelector('fluent-number-field[name="score"]').value = result.score
