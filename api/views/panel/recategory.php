        ...
        <div class="row xl">
            <div class="col xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="form" action="<?= URL ?>panel/recategory/insert" method="post">
                              ...
                              foreach ($data as $key => $value) {
                                ...
                                ?>
                                  <tr>
                                      ...
                                      <td><?= $name ?></td>
                                      <td><a class="badge badge-light" target="_blank"
                                             href="<?= URL; ?>uploads/images/<?= $cover; ?>"><?= $cover; ?></a></td>
                                      <td>
    ...
    function editRow(id) {
        superagent
            ...
            .then(res => {
                ...
                document.querySelector('#txtId').value = obj.recategory_id;
                document.querySelector('#name').value = obj.name;
                document.querySelector('#cover').value = obj.cover;
                document.querySelector('#form').action = "<?= URL ?>panel/recategory/update";
