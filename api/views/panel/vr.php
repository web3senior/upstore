                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?php if ((empty($value['cover']) || !file_exists('upload/images/' . $value['cover']))) : ?>
                                                <span class="badge badge-light">بدون تصویر</span>
                                            <?php else : ?>
                                                <a target="_blank" href="<?= URL ?>upload/images/<?= $value['cover'] ?>" class="btn-more">
                                                    <?= ICON_OPEN ?>
                                                </a>
                                            <?php endif; ?>
                                        </td>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?= URL ?>panel/<?= $this->endpoint ?>/insert" method="post" enctype="multipart/form-data" autocomplete="off">
                            ...
                            <div>
                                <fluent-text-field appearance="filled" name="url">لینک</fluent-text-field>
                            </div>

                            <div>
                                کاور
                                <input type="hidden" name="cover_hidden" value="">
    ...
    const editRow = async (id) => {
        ...
        return await fetch('<?= URL ?>panel/<?= $this->endpoint ?>/info/' + id, requestOptions)
            ...
            .then(result => {
                ...
                document.querySelector('input[name="cover"]').value = result.cover
