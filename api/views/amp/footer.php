<footer class="ampstart-footer flex flex-column items-center p3">
    <ul class="ampstart-social-follow list-reset flex justify-around items-center flex-wrap m0 mb4">
        ...
        <li class="mr2">
            <a href="https://pinterest.com" class="inline-block">
        ...
        <li class="mr2">
            <a href="mailto:contact@hielina.com" class="inline-block">
    ...
    <nav class="ampstart-footer-nav">
        <ul class="list-reset flex flex-wrap mb3">
            <li class="px1">
                <a class="text-decoration-none ampstart-label" href="<?=URL?>about">درباره ما</a>
            </li>
            <li class="px1">
                <a class="text-decoration-none ampstart-label" href="<?=URL?>contact">تماس با ما</a>
            </li>
            <li class="px1">
                <a class="text-decoration-none ampstart-label" href="<?=URL?>privacy">حریم خصوصی</a>
            </li>
        </ul>
    </nav>
    <small>© hielina, <?=date('Y')?></small>
</footer>
</body></html>